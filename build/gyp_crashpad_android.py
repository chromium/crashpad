...
def main(args):
  ...
  ndk_bin_dir = os.path.join(parsed.ndk, 'toolchains', 'llvm', 'prebuilt', 'linux-x86_64', 'bin')
  ...
  tool_prefix = 'arm-linux-androideabi' if parsed.arch == 'arm' else ARCH_TO_ARCH_TRIPLET[parsed.arch]
