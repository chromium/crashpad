...
# Minimal script to build a simple Go app.
...
def main():
  ...
  go_binary = os.path.normpath(os.path.join(
      SCRIPT_DIR, os.pardir, 'third_party', 'go', host + '-amd64', 'bin', 'go'))
  cmd = [go_binary, 'build', '-o', output_name] + args.sources
