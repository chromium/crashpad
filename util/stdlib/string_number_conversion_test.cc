...
TEST(StringNumberConversion, StringToLong) {
  ...
  static constexpr auto kTestData = kTestDataInt32<long>();
#elif __SIZEOF_LONG__ == 8
  static constexpr auto kTestData = kTestDataInt64<long>();
#endif
...
TEST(StringNumberConversion, StringToUnsignedLong) {
  static_assert(
      ...
      "Test not configured for " STRINGIFY(__SIZEOF_LONG__) "-byte long");
#if (__SIZEOF_LONG__ == 4)
  static constexpr auto kTestData = kTestDataUInt32<unsigned long>();
#elif (__SIZEOF_LONG__ == 8)
  static constexpr auto kTestData = kTestDataUInt64<unsigned long>();
#endif
