...
static const char* const kExceptionSinkholes[] = {
    ...
    "__CFRunLoopRun",
  "-[ApplicationDelegate application:didFinishLaunchingWithOptions",
...
static id ObjcExceptionPreprocessor(id exception) {
  ...
  LOG(INFO) << "Dump a lastexception process info here for " << exception;
...
//  // Set a key here that we for-realz-crash-on-exception.
//  LOG(INFO) << "Set for-realz-crash-on-exception for " << exception;
//}
