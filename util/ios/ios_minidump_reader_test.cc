...
TEST_F(IOSMinidumpReader, InvalidArrays) {
  internal::IOSMinidumpReader reader;

  uint8_t version = 1;
  internal::IOSMinidumpWriterUtil::IOSMinidumpWriterUtil::ArrayStart(fd(),
                                                                     "array1");
  internal::IOSMinidumpWriterUtil::IOSMinidumpWriterUtil::ArrayStart(fd(),
                                                                     "array2");
...
TEST_F(IOSMinidumpReader, InvalidPropertyInArray) {
  internal::IOSMinidumpReader reader;
