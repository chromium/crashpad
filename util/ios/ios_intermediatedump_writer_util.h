...
class IOSIntermediatedumpWriterUtil final {
 public:
  static void ArrayMapStart(int fd);

  static void MapStart(int fd, IntermediateDumpKey key);

  static void ArrayStart(int fd, IntermediateDumpKey key);
 ...
 private:
  DISALLOW_IMPLICIT_CONSTRUCTORS(IOSIntermediatedumpWriterUtil);
};
