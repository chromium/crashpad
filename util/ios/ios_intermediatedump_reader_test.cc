...
TEST_F(IOSIntermediatedumpReader, ReadValidData) {
  internal::IOSIntermediatedumpReader reader;
  uint8_t version = 1;
  internal::IOSIntermediatedumpWriterUtil::Property(
...
TEST_F(IOSIntermediatedumpReader, InvalidArrays) {
  ...
  uint8_t version = 1;
  internal::IOSIntermediatedumpWriterUtil::IOSIntermediatedumpWriterUtil::
      ArrayStart(fd(), "array1");
  internal::IOSIntermediatedumpWriterUtil::IOSIntermediatedumpWriterUtil::
      ArrayStart(fd(), "array2");
