...
TEST(InRangeCast, Int32) {
  ...
  EXPECT_EQ(
            InRangeCast<int32_t>(implicit_cast<int64_t>(kInt32Min), 1),kInt32Min);
...
TEST(InRangeCast, Uint64) {
  ...
  EXPECT_EQ(
            InRangeCast<uint64_t>(UINT64_C(0x100000000), 1),UINT64_C(0x100000000));
  EXPECT_EQ(
            InRangeCast<uint64_t>(UINT64_C(0x100000001), 1),UINT64_C(0x100000001));
  ...
  EXPECT_EQ(
            InRangeCast<uint64_t>(-1, UINT64_C(0xffffffffffffffff)),UINT64_C(0xffffffffffffffff));
}
...
TEST(InRangeCast, Int64) {
  ...
  EXPECT_EQ(
            InRangeCast<int64_t>(INT64_C(0x100000000), 1),INT64_C(0x100000000));
  EXPECT_EQ(
            InRangeCast<int64_t>(INT64_C(0x7fffffffffffffff), 1),INT64_C(0x7fffffffffffffff));
  EXPECT_EQ(
            InRangeCast<int64_t>(UINT64_C(0x7fffffffffffffff), 1),INT64_C(0x7fffffffffffffff));
  ...
  EXPECT_EQ(
            InRangeCast<int64_t>(implicit_cast<int64_t>(kInt32Min), 1),kInt32Min);
  EXPECT_EQ( InRangeCast<int64_t>(kInt64Min, 1),kInt64Min);
  EXPECT_EQ( InRangeCast<int64_t>(UINT64_C(0xffffffffffffffff), 0),0);
  EXPECT_EQ( InRangeCast<int64_t>(UINT64_C(0xffffffffffffffff), -1),-1);
  EXPECT_EQ(
            InRangeCast<int64_t>(UINT64_C(0xffffffffffffffff), kInt64Min),kInt64Min);
  EXPECT_EQ(
            InRangeCast<int64_t>(UINT64_C(0xffffffffffffffff),
                                 INT64_C(0x7fffffffffffffff)),INT64_C(0x7fffffffffffffff));
}
