...
#ifndef CRASHPAD_UTIL_FILE_VMO_FILE_WRITER_FUCHSIA_H_
#define CRASHPAD_UTIL_FILE_VMO_FILE_WRITER_FUCHSIA_H_
...
class VMOFileWriter : public StringFile {
 public:
  ...
  //     zx_status_t error otherwise. The error message is logged.
  //
...
#endif  // CRASHPAD_UTIL_FILE_VMO_FILE_WRITER_FUCHSIA_H_
