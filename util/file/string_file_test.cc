...
TEST(StringFile, SetString) {
  ...
  EXPECT_EQ(
            string_file.Seek(0, SEEK_END),static_cast<FileOffset>(strlen(kString1)));
  ...
  EXPECT_EQ(
            string_file.Seek(0, SEEK_END),static_cast<FileOffset>(strlen(kString2)));
  ...
  EXPECT_EQ(
            string_file.Seek(0, SEEK_END),static_cast<FileOffset>(strlen(kString3)));
...
TEST(StringFile, WriteIoVec) {
  ...
  EXPECT_EQ(
            string_file.string(),"abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd");
...
TEST(StringFile, SeekSparse) {
  ...
  EXPECT_EQ(
            string_file.string(),std::string("\0\0\0abc\0g\0def\0\0\0hij", 18));
