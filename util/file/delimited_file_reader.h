...
//!
//! It is safe to mix GetLine() and GetDelim() calls, if appropriate for the
//! format being interpreted.
//!
//! This is a replacement for the standard library’s `getline()` and
//! `getdelim()` functions, adapted to work with FileReaderInterface objects
...
class DelimitedFileReader {
 public:
  ...
  //! \param[out] field The field read from the file. On success, this parameter
  //!     will include the field’s terminating delimiter character unless the
  //!     field was at the end of the file and was read without such a
  //!     character. On success, this parameter will not be empty.
  //!
  ...
  //!
  //! \param[out] line The line read from the file. On success, this parameter
  //!     will include the line’s terminating newline character unless the line
  //!     was at the end of the file and was read without such a character. On
  //!     On success, this parameter will not be empty.
  //!
