...
TEST(DelimitedFileReader, EmptyFile) {
  ...
  std::string line;
  EXPECT_EQ(
            delimited_file_reader.GetLine(&line),DelimitedFileReader::Result::kEndOfFile);
...
TEST(DelimitedFileReader, EmptyOneLineFile) {
  ...
  std::string line;
  ASSERT_EQ(
            delimited_file_reader.GetLine(&line),DelimitedFileReader::Result::kSuccess);
...
TEST(DelimitedFileReader, SmallMultiFieldFile) {
  ...
  std::string field;
  ASSERT_EQ(
            delimited_file_reader.GetDelim(',', &field),DelimitedFileReader::Result::kSuccess);
  ...
  EXPECT_EQ( field,"3rd,");
  EXPECT_EQ(
            delimited_file_reader.GetDelim(',', &field),DelimitedFileReader::Result::kEndOfFile);
...
TEST(DelimitedFileReader, SmallMultiFieldFile_MixedDelimiters) {
  ...
  ASSERT_EQ(
            delimited_file_reader.GetLine(&field),DelimitedFileReader::Result::kSuccess);
  EXPECT_EQ( field,"3rd\n");
  ASSERT_EQ(
            delimited_file_reader.GetDelim('\n', &field),DelimitedFileReader::Result::kSuccess);
  ...
  // The file is still at EOF.
  EXPECT_EQ(
            delimited_file_reader.GetLine(&field),DelimitedFileReader::Result::kEndOfFile);
}
...
TEST(DelimitedFileReader, NULDelimiter) {
  ...
  std::string field;
  ASSERT_EQ(
            delimited_file_reader.GetDelim('\0', &field),DelimitedFileReader::Result::kSuccess);
  ...
  EXPECT_EQ(
            delimited_file_reader.GetDelim('\0', &field),DelimitedFileReader::Result::kEndOfFile);
