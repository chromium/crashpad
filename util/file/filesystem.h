...
//!     failure.
//!
//! On POSIX, this function returns `true` if the path refers to a regular file.
//! On Windows, this function returns `true` if the path refers to a file that
...
//! \brief Deletes a file or a symbolic link to a file or directory, logging a
//!     message on failure.
//!
...
//! \brief Removes an empty directory, logging a message on failure.
//!
