...
//!
//! \a source must exist and refer to a file or symbolic link to a file or
//! directory. \a dest must not exist.
//!
//! This operation may be implemented as a copy and remove.
//!
