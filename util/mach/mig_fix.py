...
from google3.third_party.crashpad.crashpad.util.mach.mig_gen import MigInterface
...
def fix_interface(interface, fixed_interface=None):
  ...
  FixUserImplementation(interface.user_c, fixed_interface.user_c,
                        interface.user_h, fixed_interface.user_h)
  server_declarations = FixServerImplementation(interface.server_c,
                                                fixed_interface.server_c,
                                                interface.server_h,
                                                fixed_interface.server_h)
  FixHeader(interface.user_h, fixed_interface.user_h)
  FixHeader(interface.server_h, fixed_interface.server_h, server_declarations)
