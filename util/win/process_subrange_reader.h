...
#ifndef CRASHPAD_UTIL_WIN_PROCESS_SUBRANGE_READER_WIN_H_
#define CRASHPAD_UTIL_WIN_PROCESS_SUBRANGE_READER_WIN_H_
...
#endif  // CRASHPAD_UTIL_WIN_PROCESS_SUBRANGE_READER_WIN_H_
