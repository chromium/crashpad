...
class InitialClientData {
 ...
 private:
  WinVMAddress crash_exception_information_ = 0;
  WinVMAddress non_crash_exception_information_ = 0;
  WinVMAddress debug_critical_section_address_ = 0;
  HANDLE request_crash_dump_ = nullptr;
  HANDLE request_non_crash_dump_ = nullptr;
  HANDLE non_crash_dump_completed_ = nullptr;
  HANDLE first_pipe_instance_ = INVALID_HANDLE_VALUE;
  HANDLE client_process_ = nullptr;
