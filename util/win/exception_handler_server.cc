...
void ExceptionHandlerServer::InitializeWithInheritedDataForInitialClient(
  ...
  first_pipe_instance_.reset(first_pipe_instance);
  ...
  if (!GetFileInformationByHandleEx(
    ...
    PCHECK(ERROR) << "GetFinalPathNameByHandle";
  }
...

  {
    ...
    internal::ClientData* client = new internal::ClientData(
        ...
        ScopedKernelHANDLE(request_crash_dump),
        ScopedKernelHANDLE(request_non_crash_dump),
        ScopedKernelHANDLE(non_crash_dump_completed),
        crash_exception_information,
        non_crash_exception_information,
