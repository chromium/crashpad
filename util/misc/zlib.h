...
//! \brief Obtain a \a windowBits parameter to pass to `deflateInit2()` or
//!     `inflateInit2()` that specifies a `gzip` wrapper instead of the default
//!     zlib wrapper.
//!
//! \param[in] A \a windowBits value that only specifies the base-2 logarithm of
//!     the deflate sliding window size.
//!
