...
// Used by the client library to stash a pointer to g_crashpad_info for
// retrieval by the module snapshot. 1229866575 == 0x494e464f == 'INFO'.
#define CRASHPAD_ELF_NOTE_TYPE_CRASHPAD_INFO 0x494e464f
