...
// gtest under MSVS 2015 (MSC 19.0) doesn’t handle EXPECT_EQ(a, b) with all of
// the types in this test, because it can’t figure out how to print pointers to
// volatile types. This is fixed in MSVS 2017 (MSC 19.1).
