...
#if defined(OS_WIN)
  const char kUMAExceptionCodeString[] = "Crashpad.ExceptionCode.Win";
#elif defined(OS_MACOSX)
  const char kUMAExceptionCodeString[] = "Crashpad.ExceptionCode.Mac";
#endif
  UMA_HISTOGRAM_SPARSE_SLOWLY(kUMAExceptionCodeString,
