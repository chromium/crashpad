...
#if defined(OS_WIN)
  const char kExceptionString[] = "Crashpad.ExceptionCode.Win";
#elif defined(OS_MACOSX)
  const char kExceptionString[] = "Crashpad.ExceptionCode.Mac";
#endif
  UMA_HISTOGRAM_SPARSE_SLOWLY(kExceptionString,
