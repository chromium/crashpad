...
//
// In C++14, this could use std::is_null_pointer<From>::type instead of the
// is_same<remove_cv<From>::type, nullptr_t>::type construct.
template <typename To, typename From>
...
FromPointerCast(From) {
  return reinterpret_cast<To>(nullptr);
}
