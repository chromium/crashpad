...
.text
.global "?CaptureContext@crashpad@@YAXPEAU_CONTEXT@@@Z"
.balign 16, 0x0

"?CaptureContext@crashpad@@YAXPEAU_CONTEXT@@@Z":
  ...
  mrs x1, NZCV
  str x1, [x0, #0x004]  // context.cpsr

  // Set Control flags, enable CONTEXT_ARM64, CONTEXT_CONTROL, CONTEXT_INTEGER
  ldr x1, =0x00400003
  str x1, [x0, #0x000]
