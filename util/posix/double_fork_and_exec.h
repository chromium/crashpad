...
//! with process ID 1, relieving the process that started it of the
//! responsibility to reap the grandchild via `waitpid()`. Aside from the three
//! file descriptors associated with the standard input/output streams and any
//! file descriptor passed in \a preserve_fd, the grandchild will not inherit
//! any file descriptors from the parent process.
//!
