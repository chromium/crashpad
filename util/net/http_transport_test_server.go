...
// http_transport_test_server is a one-shot testing webserver.
//
...
// stdin, indicating the response code to be sent in response to a request. It
...
// consumeBodyAndDumpRequest is a stripped down version of net/http/httputil's
// DumpRequest tweaked to emit the body de-chunked and de-gzip'd. This is done
// mostly for compatibility with the previous Python version of this script.
