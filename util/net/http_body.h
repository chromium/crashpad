...
//! \brief An implementation of HTTPBodyStream that reads from a FileReader and
//!     provides its contents for an HTTP body.
class FileReaderHTTPBodyStream : public HTTPBodyStream {
 public:
  //! \brief Creates a stream for reading from a FileReader.
  //!
  //! \param[in] reader A FileReader from which this HTTPBodyStream will read.
