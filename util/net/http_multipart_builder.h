...
class HTTPMultipartBuilder {
 public:
  ...
  //! GetBodyStream() will be compressed by `gzip`, and the content headers
  //! set by PopulateContentHeaders() will contain `Content-Encoding: gzip`.
  ...
  //! \brief Adds the appropraite content headers to \a http_headers.
