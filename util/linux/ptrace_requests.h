...
enum class GetRegistersResult {
  //! \brief An error occurred with a message logged and no field of the union
  //!     is valid.
  kError = 0,

  //! \brief ThreadContext::t32 or FloatContext::f32 is active.
  k32Bit,

  //! \brief ThreadContext::t64 or FloatContext::f64 is active.
  k64Bit
};
...
//!     process whose process ID is \a pid and placess the result in address.
//!
//! The target process must be ptrace-attached before calling this function.
//!
//! \param[in] pid The process ID to determine the TLS area address for.
