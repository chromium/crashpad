...
static_assert(std::is_standard_layout<ThreadContext>::value,
              "ThreadContext not standard layout");
static_assert(std::is_standard_layout<FloatContext>::value,
              "FloatContext not standard layout");
...
static_assert(std::is_standard_layout<USER_GPR_STRUCT>::value,
              "USER_GPR_STRUCT isn't standard layout");

#if defined(ARCH_CPU_X86_FAMILY)
#define USER_FPR_STRUCT user_fpregs_struct
#elif defined(ARCH_CPU_ARM64)
#define USER_FPR_STRUCT user_fpsimd_struct
#elif defined(ARCH_CPU_ARMEL)
#define USER_FPR_STRUCT user_fpregs
#else
#error Port.
#endif
static_assert(std::is_standard_layout<USER_FPR_STRUCT>::value,
              "USER_FPR_STRUCT isn't standard layout");

#if defined(ARCH_CPU_64_BITS)
#define GPR_STRUCT ThreadContext::t64
#define FPR_STRUCT FloatContext::f64
#else
#define GPR_STRUCT ThreadContext::t32
#define FPR_STRUCT FloatContext::f32
#endif

static_assert(sizeof(GPR_STRUCT) == sizeof(USER_GPR_STRUCT),
              "Incorrect gpr struct size");
static_assert(sizeof(FPR_STRUCT) == sizeof(USER_FPR_STRUCT),
              "Incorrect fpr struct size");

#undef USER_GPR_STRUCT
#undef USER_FPR_STRUCT
#undef GPR_STRUCT
#undef FPR_STRUCT
