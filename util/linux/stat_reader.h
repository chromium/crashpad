...
#ifndef CRASHPAD_UTIL_LINUX_STAT_READER_H_
#define CRASHPAD_UTIL_LINUX_STAT_READER_H_
...
class StatReader {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(StatReader);
};

}  // namespace crashpad

#endif  // CRASHPAD_UTIL_LINUX_STAT_READER_H_
