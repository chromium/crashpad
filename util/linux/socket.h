...
bool CredentialSocketpair(ScopedFileHandle* s1, ScopedFileHandle* s2);

//! \brief The maximum number of file descriptors that may be sent/received with
//!     `SendMsg()` or `RecvMsg()`.
...
//!     Optional.
//! \param[in] fd_count The number of file descriptors in \a fds. Required only
//!     if \a fds was set.
