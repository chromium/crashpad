...
// mips32 via ptrace because NT_PRSTATUS treats them as array of 32bit elements,
// contrary to how they are treated as arrays of 64bit elements by kernel and
// eg. ucontext_t structure, among others.
// This struct is based on how gpr32_get function in arch/mips/kernel/ptrace.c
// fills output buffer with register values.
  typedef struct {
