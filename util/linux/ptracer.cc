...
bool GetGeneralPurposeRegistersLegacy(pid_t tid,
  ...
  for (size_t reg = 0; reg < 32; ++reg) {
    context->t32.regs[reg] = context_buffer.t64.regs[reg];
  }
  context->t32.lo = context_buffer.t64.lo;
  context->t32.hi = context_buffer.t64.hi;
  context->t32.cp0_epc = context_buffer.t64.cp0_epc;
  context->t32.cp0_badvaddr = context_buffer.t64.cp0_badvaddr;
  context->t32.cp0_status = context_buffer.t64.cp0_status;
  context->t32.cp0_cause = context_buffer.t64.cp0_cause;
  return true;
}
