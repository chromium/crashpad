...
//!
//! This class is typically used when the current process does not have `ptrace`
//! capabilities on the target process. It should be created with a socket
//! connected to a PtraceBroker.
class PtraceClient : public PtraceConnection {
 public:
  ...
  //! class.
  //!
  //! \param[in] sock A socket connected to a PtraceBroker.
