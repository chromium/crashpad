...
#ifndef CRASHPAD_UTIL_POSIX_SCOPED_PTRACE_ATTACH_H_
#define CRASHPAD_UTIL_POSIX_SCOPED_PTRACE_ATTACH_H_
...
#endif  // CRASHPAD_UTIL_POSIX_SCOPED_PTRACE_ATTACH_H_
