...
StatReader::StatReader() : tid_(-1) {}

StatReader::~StatReader() {}

bool StatReader::Initialize(pid_t tid) {
...
bool StatReader::StartTime(timeval* start_time) const {
...
bool StatReader::ReadFile(std::string* contents) const {
  char path[32];
