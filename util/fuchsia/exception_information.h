...
#ifndef CRASHPAD_UTIL_FUCHSIA_EXCEPTION_INFORMATION_H_
#define CRASHPAD_UTIL_FUCHSIA_EXCEPTION_INFORMATION_H_
...
#endif  // CRASHPAD_UTIL_FUCHSIA_EXCEPTION_INFORMATION_H_
