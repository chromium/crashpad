...
#ifndef CRASHPAD_UTIL_PROCESS_PROCESS_MEMORY_IOS_H_
#define CRASHPAD_UTIL_PROCESS_PROCESS_MEMORY_IOS_H_
...
class ProcessMemoryIOS : public ProcessMemory {
 public:
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ProcessMemoryIOS);
};

}  // namespace crashpad

#endif  // CRASHPAD_UTIL_PROCESS_PROCESS_MEMORY_IOS_H_
