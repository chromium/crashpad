...
class ProcessMemorySanitized final : public ProcessMemory {
 public:
  ...
  //!     \a memory object if the memory range is in the provided \a allowlist.
  //!
  //! This method must be called successfully prior to calling any other method
  //! in this class.
  //!
  //! \param[in] memory The memory object to read allowlisted regions from.
  //! \param[in] allowlist A allowlist of memory regions.
  //!
 ...
 private:
  ...
  std::vector<std::pair<VMAddress, VMAddress>> allowlist_;
