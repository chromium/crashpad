...
ProcessMemoryLinux::ProcessMemoryLinux() : mem_fd_(), pid_(-1) {}
...
bool ProcessMemoryLinux::Read(VMAddress address, size_t size,
                              void* buffer) const {
...
bool ProcessMemoryLinux::ReadCStringInternal(VMAddress address, bool has_size,
                                             size_t size,
