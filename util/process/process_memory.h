...
class ProcessMemory {
 public:
  ...
  //!     encountering unmapped or unreadable pages.
  bool ReadCStringSizeLimited(VMAddress address, size_t size,
 ...
 protected:
  ...
  virtual bool ReadCStringInternal(VMAddress address, bool has_size,
                                   size_t size, std::string* string) const = 0;
