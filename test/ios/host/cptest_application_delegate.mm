...
- (BOOL)validateAnnotations {
  ...
  LOG(WARNING) << process_snapshot.Modules()[0]->AnnotationsSimpleMap()["#TEST# longer"];
  return process_snapshot.Modules()[0]->AnnotationsSimpleMap()["#TEST# longer"] == "shorter";
