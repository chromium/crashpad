...
#include "test/win/win_multiprocess_with_tempdir.h"
...
void WinMultiprocessWithTempDir::WinMultiprocessParentAfterChild(HANDLE child) {
  // DO NOT SUBMIT - does this belong here?
...
void WinMultiprocessWithTempDir::WaitForAllChildProcessesOf(HANDLE parent) {
