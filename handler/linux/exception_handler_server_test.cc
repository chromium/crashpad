  ...
  class CrashDumpTest : public Multiprocess {
   public:
    ...
    void MultiprocessChild() override {
      ...
      // ptracer allows the broker to inherit this capability.
...
TEST_F(ExceptionHandlerServerTest, RequestCrashDumpSystem) {
...
TEST_F(ExceptionHandlerServerTest, RequestCrashDumpNoPtrace) {
  ...
  Server()->SetPtraceStrategyDecider(
      std::make_unique<MockPtraceStrategyDecider>(
...
TEST_F(ExceptionHandlerServerTest, RequestCrashDumpForkBroker) {
  ...
  Server()->SetPtraceStrategyDecider(
      std::make_unique<MockPtraceStrategyDecider>(
          PtraceStrategyDecider::Strategy::kForkBroker));
