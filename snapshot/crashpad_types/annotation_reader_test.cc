...
class ReadFromChildTest : public Multiprocess {
 public:
  ReadFromChildTest()
    ...
    static const char kAnnotationName[] = "test annotation";
    static const char kAnnotationValue[] = "test annotation value";
    test_annotation_ = std::make_unique<Annotation>(
        Annotation::Type::kString,
        kAnnotationName,
        reinterpret_cast<void*>(const_cast<char*>(kAnnotationValue)));
    test_annotation_->SetSize(arraysize(kAnnotationValue));
