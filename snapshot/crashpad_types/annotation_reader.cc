...
AnnotationReader::AnnotationReader(const ProcessMemoryRange* memory)
    : memory_(memory) {}

AnnotationReader::~AnnotationReader() = default;

bool AnnotationReader::SimpleMap(
    VMAddress address,
...
bool AnnotationReader::AnnotationList(
    VMAddress address,
...
template <class Traits>
bool AnnotationReader::ReadAnnotationList(
    VMAddress address,
    std::vector<AnnotationSnapshot>* annotations) const {
