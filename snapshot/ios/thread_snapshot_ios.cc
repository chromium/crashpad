...
bool ThreadSnapshotIOS::Initialize(thread_t thread) {
  ...
  // TODO(justincohen): Needs verification and a comment similar to
  // process_reader_mac thread_handle.
  ...
  InitializeCPUContext(
      &context_x86_64_, &thread_state, &float_state, &debug_state);
#elif defined(ARCH_CPU_ARM64)
  context_.architecture = kCPUArchitectureARM64;
  context_.arm64 = &context_arm64_;
  InitializeCPUContext(&context_arm64_, &thread_state, &float_state);
#endif
