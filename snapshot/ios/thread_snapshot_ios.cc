...
#include "util/process/process_memory_ios.h"
...
bool ThreadSnapshotIOS::Initialize(thread_t thread) {
  ...
  ProcessMemoryIOS process_memory;
  stack_.Initialize(&process_memory, stack_region_address, stack_region_size);

#if defined(ARCH_CPU_ARM64)
  context_.architecture = kCPUArchitectureARM64;
  context_.arm64 = &type_context_;
  memcpy(type_context_.regs, thread_state.__x, sizeof(type_context_.regs));
  type_context_.sp = thread_state.__sp;
  type_context_.pc = thread_state.__pc;
  type_context_.spsr =
      static_cast<decltype(type_context_.spsr)>(thread_state.__cpsr);
  memcpy(type_context_.fpsimd, float_state.__v, sizeof(float_state.__v));
  type_context_.fpsr = float_state.__fpsr;
  type_context_.fpcr = float_state.__fpcr;
#else
  context_.architecture = kCPUArchitectureX86_64;
  context_.x86_64 = &type_context_;
  type_context_.rax = thread_state.__rax;
  type_context_.rbx = thread_state.__rbx;
  type_context_.rcx = thread_state.__rcx;
  type_context_.rdx = thread_state.__rdx;
  type_context_.rdi = thread_state.__rdi;
  type_context_.rsi = thread_state.__rsi;
  type_context_.rbp = thread_state.__rbp;
  type_context_.rsp = thread_state.__rsp;
  type_context_.r8 = thread_state.__r8;
  type_context_.r9 = thread_state.__r9;
  type_context_.r10 = thread_state.__r10;
  type_context_.r11 = thread_state.__r11;
  type_context_.r12 = thread_state.__r12;
  type_context_.r13 = thread_state.__r13;
  type_context_.r14 = thread_state.__r14;
  type_context_.r15 = thread_state.__r15;
  type_context_.rip = thread_state.__rip;
  type_context_.rflags = thread_state.__rflags;
  type_context_.cs = thread_state.__cs;
  type_context_.fs = thread_state.__fs;
  type_context_.gs = thread_state.__gs;
  memcpy(&type_context_.fxsave,
         &float_state.__fpu_fcw,
         sizeof(type_context_.fxsave));
  type_context_.dr0 = debug_state.__dr0;
  type_context_.dr1 = debug_state.__dr1;
  type_context_.dr2 = debug_state.__dr2;
  type_context_.dr3 = debug_state.__dr3;
  type_context_.dr4 = debug_state.__dr4;
  type_context_.dr5 = debug_state.__dr5;
  type_context_.dr6 = debug_state.__dr6;
  type_context_.dr7 = debug_state.__dr7;
#endif
