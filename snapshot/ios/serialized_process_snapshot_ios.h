...
#ifndef CRASHPAD_SNAPSHOT_IOS_SERIALIZED_PROCESS_SNAPSHOT_IOS_H_
#define CRASHPAD_SNAPSHOT_IOS_SERIALIZED_PROCESS_SNAPSHOT_IOS_H_
...
//!     iphoneOS system.
class SerializedProcessSnapshotIOS final : public ProcessSnapshot {
 public:
  SerializedProcessSnapshotIOS();
  ~SerializedProcessSnapshotIOS() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(SerializedProcessSnapshotIOS);
};

}  // namespace crashpad

#endif  // CRASHPAD_SNAPSHOT_IOS_SERIALIZED_PROCESS_SNAPSHOT_IOS_H_
