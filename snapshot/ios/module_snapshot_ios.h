// Copyright 20 The Crashpad Authors. All rights reserved.
//
...
class ModuleSnapshotIOS final : public ModuleSnapshot {
 public:
  ...
  //!
  //! \param[in] process_reader A ProcessReaderIOS for the task containing the
  //!     module.
  //! \param[in] process_reader_module The module within the ProcessReaderIOS
  //!     for which the snapshot should be created.
  //!
  //! \return `true` if the snapshot could be created, `false` otherwise with
  //!     an appropriate message logged.
  bool Initialize(ProcessReaderIOS* process_reader,
 ...
 private:
  std::string name_;
  time_t timestamp_;
  ProcessReaderIOS* process_reader_;  // weak
