...
class ModuleSnapshotIOS final : public ModuleSnapshot {
 public:
  ...
  //!
  //! \param[in] dyld_image_info
  //!     module.
  //! \param[in] is_dyld
  //!
  //! \return `true` if the snapshot could be created, `false` otherwise with
  //!     an appropriate message logged.
  bool Initialize(const dyld_image_info*);

  bool InitializeDyld(const dyld_all_image_infos*);
  ...
  static mach_vm_address_t DyldAllImageInfo(
 ...
 private:
  ...
  bool ValidateMemory(const void* const memory, const int byte_count);
