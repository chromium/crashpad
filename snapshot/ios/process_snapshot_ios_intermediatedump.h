...
#ifndef CRASHPAD_SNAPSHOT_IOS_INTERMEDIATEDUMP_PROCESS_SNAPSHOT_IOS_INTERMEDIATEDUMP_H_
#define CRASHPAD_SNAPSHOT_IOS_INTERMEDIATEDUMP_PROCESS_SNAPSHOT_IOS_INTERMEDIATEDUMP_H_
...
class ProcessSnapshotIOSIntermediatedump final : public ProcessSnapshot {
 ...
 private:
  internal::IOSIntermediatedumpReader reader_;
  pid_t p_pid_;
  pid_t e_ppid_;
...
#endif  // CRASHPAD_SNAPSHOT_IOS_INTERMEDIATEDUMP_PROCESS_SNAPSHOT_IOS_INTERMEDIATEDUMP_H_
