...
void ExpectElfImageWithSymbol(pid_t pid, VMAddress address, bool is_64_bit,
...
void ReadThisExecutableInTarget(pid_t pid) {
  ...
  ExpectElfImageWithSymbol(
      pid, elf_address, am_64_bit, "ElfImageReaderTestExportedSymbol",
...
void ReadLibcInTarget(pid_t pid) {
  ...
  ExpectElfImageWithSymbol(pid, elf_address, am_64_bit, "getpid",
