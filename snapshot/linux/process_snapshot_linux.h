...
class ProcessSnapshotLinux final : public ProcessSnapshot {
 public:
  ...
  //!
  //! \param[in] pid The process ID of the process to create a snapshot from.
  //!
  ...
  //!
  bool InitializeException(LinuxVMAddress exceptionInfo);
 ...
 private:
  ...
  SystemSnapshotLinux system_;
  PointerVector<internal::ThreadSnapshotLinux> threads_;
