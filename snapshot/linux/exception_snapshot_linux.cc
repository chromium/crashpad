...
static bool ReadContext(ProcessReaderLinux* reader,
  ...
  LinuxVMAddress gregs_address =
      context_address + offsetof(UContext<Traits>, mcontext) +
...
bool ExceptionSnapshotLinux::ReadContext<ContextTraits32>(
  ...
  ContextTraits32::CPUContext* dest_context = context_.mipsel;

  return internal::ReadContext<ContextTraits32>(reader, context_address,
                                                dest_context);
}
...
bool ExceptionSnapshotLinux::ReadContext<ContextTraits64>(
  ...
  ContextTraits64::CPUContext* dest_context = context_.mips64el;

  return internal::ReadContext<ContextTraits64>(reader, context_address,
                                                dest_context);
}
