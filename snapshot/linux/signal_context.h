...
static_assert(offsetof(UContext<ContextTraits64>, sigmask) ==
              ...
              "sigmask offset mismtach");
static_assert(sizeof(UContext<ContextTraits64>::sigmask) ==
                  sizeof(ucontext_t::uc_sigmask),
              "sigmask size mismatch");
static_assert(sizeof(UContext<ContextTraits64>::padding) ==
                  sizeof(ucontext_t::__padding),
              "padding size mismatch");
