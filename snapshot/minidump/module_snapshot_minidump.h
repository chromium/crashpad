...
class ModuleSnapshotMinidump final : public ModuleSnapshot {
 ...
 private:
  ...
  // Initializes data from the CodeView record, which usually points us toward
  // debug symbols.
  bool InitializeModuleCv(FileReaderInterface* file_reader);
  bool InitializeModuleCvPB70(FileReaderInterface* file_reader);
  bool InitializeModuleCvGOOG(FileReaderInterface* file_reader);
