...
TEST(ProcessSnapshotMinidump, MiscTimes) {
  ...
  EXPECT_EQ(start_time.tv_sec, misc_info.ProcessCreateTime);
  EXPECT_EQ(start_time.tv_usec, 0);
  EXPECT_EQ(user_time.tv_sec, misc_info.ProcessUserTime);
  EXPECT_EQ(user_time.tv_usec, 0);
  EXPECT_EQ(kernel_time.tv_sec, misc_info.ProcessKernelTime);
