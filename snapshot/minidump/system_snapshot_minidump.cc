...
CPUArchitecture SystemSnapshotMinidump::GetCPUArchitecture() const {
  ...
  /* There's no internal representation for the rest of these */
  case kMinidumpCPUArchitectureAlpha:
  case kMinidumpCPUArchitecturePPC:
  case kMinidumpCPUArchitectureSHx:
  case kMinidumpCPUArchitectureIA64:
  case kMinidumpCPUArchitectureAlpha64:
  case kMinidumpCPUArchitectureMSIL:
  case kMinidumpCPUArchitectureNeutral:
  case kMinidumpCPUArchitectureSPARC:
  case kMinidumpCPUArchitecturePPC64:
  default:
...
SystemSnapshot::OperatingSystem
  ...
  case kMinidumpOSUnix:
  case kMinidumpOSiOS:
  case kMinidumpOSSolaris:
  case kMinidumpOSPS3:
  case kMinidumpOSNaCl:
  case kMinidumpOSUnknown:
  default:
