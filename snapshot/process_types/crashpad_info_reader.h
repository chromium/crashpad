...
#ifndef CRASHPAD_SNAPSHOT_PROCESS_TYPES_CRASHPAD_INFO_READER_H_
#define CRASHPAD_SNAPSHOT_PROCESS_TYPES_CRASHPAD_INFO_READER_H_
...
#endif  // CRASHPAD_SNAPSHOT_PROCESS_TYPES_CRASHPAD_INFO_READER_H_
