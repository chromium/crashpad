...
#ifndef CRASHPAD_SNAPSHOT_FUCHSIA_MEMORY_SNAPSHOT_FUCHSIA_H_
#define CRASHPAD_SNAPSHOT_FUCHSIA_MEMORY_SNAPSHOT_FUCHSIA_H_
...
//! \brief A MemorySnapshot of a memory region in a process on a Fuchsia system.
class MemorySnapshotFuchsia final : public MemorySnapshot {
 public:
  MemorySnapshotFuchsia();
  ~MemorySnapshotFuchsia() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MemorySnapshotFuchsia);
};

}  // namespace internal
}  // namespace crashpad

#endif  // CRASHPAD_SNAPSHOT_FUCHSIA_MEMORY_SNAPSHOT_FUCHSIA_H_
