...
#ifndef CRASHPAD_SNAPSHOT_FUCHSIA_SNAPSHOT_CPU_CONTEXT_FUCHSIA_H_
#define CRASHPAD_SNAPSHOT_FUCHSIA_SNAPSHOT_CPU_CONTEXT_FUCHSIA_H_
...
#endif  // CRASHPAD_SNAPSHOT_FUCHSIA_SNAPSHOT_CPU_CONTEXT_FUCHSIA_H_
