...
void ProcessReader::InitializeModules() {
  ...
  // really expose any of the data that's necessary to fill out a Module after
  // it retrieves (some of) the data into internal structures. Once this is
  // working in Crashpad, consider trying to upstream this in to Fuchsia-proper.
