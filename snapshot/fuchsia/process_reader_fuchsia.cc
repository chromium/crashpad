...
#error Port
  ...
  // Because Fuchsia uses safestack, it is very unlikely that a stack this large
  // would be valid. Even if it were, avoid creating unreasonably large dumps by
  // artificially limiting the captured amount.
  constexpr uint64_t kMaxStackCapture = 8192;
