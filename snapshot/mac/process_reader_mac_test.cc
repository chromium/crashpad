...
void* GetDyldFunction(const char* symbol) {
...
void VerifyImageExistenceAndTimestamp(const char* path, time_t timestamp) {
  ...
  using DyldSharedCacheContainsPathType = bool (*)(const char*);
  static DyldSharedCacheContainsPathType _dyld_shared_cache_contains_path =
      reinterpret_cast<DyldSharedCacheContainsPathType>(
          GetDyldFunction("_dyld_shared_cache_contains_path"));
#endif
...
#pragma clang diagnostic pop
    ...
    static const char* dyld_shared_cache_file_path = []() -> const char* {
      using DyldSharedCacheFilePathType = const char* (*)();
      DyldSharedCacheFilePathType dyld_shared_cache_file_path_f =
          reinterpret_cast<DyldSharedCacheFilePathType>(
              GetDyldFunction("dyld_shared_cache_file_path"));
