...
class TestMachOImageAnnotationsReader final
 ...
 private:
  ...
  void MachMultiprocessChild() override {
    ...
    StringAnnotation<32> test_annotation_one{"#TEST# one"};
    StringAnnotation<32> test_annotation_two{"#TEST# two"};
    StringAnnotation<32> test_annotation_three{"#TEST# same-name"};
    StringAnnotation<32> test_annotation_four{"#TEST# same-name"};
