  ...
  if (is_64_bit) {
    if (!InitializeFromExceptionPointers<EXCEPTION_RECORD64,
            ...
            *process_reader,
            ...
            threads,
            &ExceptionSnapshotWin::NativeContextToCPUContext64)) {
      return false;
    }
  }
#endif
  if (!is_64_bit) {
    if (!InitializeFromExceptionPointers<EXCEPTION_RECORD32,
            ...
            *process_reader,
            exception_pointers_address,
            threads,
            &ExceptionSnapshotWin::NativeContextToCPUContext32)) {
      return false;
    }
  }
...
bool ExceptionSnapshotWin::InitializeFromExceptionPointers(
  ...
  if (first_record.ExceptionCode == CrashpadClient::kTriggeredExceptionCode &&
    ...
    exception_code_ = first_record.ExceptionInformation[1];
    ...
    (this->*native_to_cpu_context)(context_record);
  }
...
void ExceptionSnapshotWin::NativeContextToCPUContext64(
...
void ExceptionSnapshotWin::NativeContextToCPUContext32(
    const Context32& context_record) {
