...
constexpr char kWhitelistedAnnotationName[] = "name_of_allowlisted_anno";
constexpr char kWhitelistedAnnotationValue[] = "some_value";
constexpr char kNonWhitelistedAnnotationName[] = "non_allowlisted_anno";
...
void ChildTestFunction() {
  ...
  allowlisted_annotation.Set(kWhitelistedAnnotationValue);

  static StringAnnotation<32> non_allowlisted_annotation(
      kNonWhitelistedAnnotationName);
  non_allowlisted_annotation.Set(kNonWhitelistedAnnotationValue);
...
class SanitizeTest : public MultiprocessExec {
 ...
 private:
  void MultiprocessParent() {
    ...
    annotations_allowlist->push_back(kWhitelistedAnnotationName);
