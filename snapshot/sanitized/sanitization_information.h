...
struct SanitizationInformation {
  ...
  //!     names of allowed annotations. Set this value to 0 if all annotations
  //!     are allowed.
  ...
  //!     to be accessed by ProcessMemorySanitized. This value
...
//! \param[in] list_address The address in the target process' address
