...
void Usage(const base::FilePath& me) {
  fprintf(stderr,
          ...
          "Options:\n"
          "\n"
          "  -e, --encode   compress and encode the input file to a base94\n"
          "                 encoded file\n"
...
int MinidumpLogProcessMain(int argc, char* argv[]) {
  ...
  options.input_file = base::FilePath(argv[0]);
  options.output_file = base::FilePath(argv[1]);
...
int main(int argc, char* argv[]) {
  return crashpad::MinidumpLogProcessMain(argc, argv);
}
