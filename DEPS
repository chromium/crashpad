...
deps = {
  ...
  'crashpad/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios@' +
           '11ba078b597dfa28cc718facdd053c8321d088c5',
    'condition': 'pull_ios_bot_support'
  },
  'crashpad/testing': {
    'url': Var('chromium_git') + '/chromium/src/testing@' +
           'b1a11372f79ebb2cff4cd206772fdef86fab98c1',
    'condition': 'pull_ios_bot_support'
  },
  'crashpad/tools/luci-go': {
      'packages': [
        {
