        ...
        case x86_THREAD_STATE: {
          ...
          switch (state->tsh.flavor) {
            case x86_THREAD_STATE32:
              EXPECT_EQ(
                        state->tsh.count,implicit_cast<int>(x86_THREAD_STATE32_COUNT));
              break;
            case x86_THREAD_STATE64:
              EXPECT_EQ(
                        state->tsh.count,implicit_cast<int>(x86_THREAD_STATE64_COUNT));
              break;
            default:
        ...
        case x86_FLOAT_STATE: {
          ...
          switch (state->fsh.flavor) {
            case x86_FLOAT_STATE32:
              EXPECT_EQ(
                        state->fsh.count,implicit_cast<int>(x86_FLOAT_STATE32_COUNT));
              break;
            case x86_FLOAT_STATE64:
              EXPECT_EQ(
                        state->fsh.count,implicit_cast<int>(x86_FLOAT_STATE64_COUNT));
              break;
            default:
        ...
        case x86_DEBUG_STATE: {
          ...
          switch (state->dsh.flavor) {
            case x86_DEBUG_STATE32:
              EXPECT_EQ(
                        state->dsh.count,implicit_cast<int>(x86_DEBUG_STATE32_COUNT));
              break;
            case x86_DEBUG_STATE64:
              EXPECT_EQ(
                        state->dsh.count,implicit_cast<int>(x86_DEBUG_STATE64_COUNT));
              break;
            default:
