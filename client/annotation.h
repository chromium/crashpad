...
class Annotation {
 public:
  ...
  //!     Annotations with the same name. Names should be static, constexpr data.
  //! \param[in] value_ptr A pointer to the value for the annotation. The pointer
  //      may not be changed once associated with an annotation, but the data
  //!     may be mutated.
