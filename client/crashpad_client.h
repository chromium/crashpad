...
class CrashpadClient {
 public:
  ...
  enum : uint32_t {
    ...
    //! DumpAndCrashTargetProcess() triggers an exception in a target process.
    //! Note that we avoid setting the top nibble, as most real exception codes
    //! have some top nibble bits set.
