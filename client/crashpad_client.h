...
class CrashpadClient {
 public:
  ...
  //! the calling thread and should be called early in the lifetime for each
  ...
  //! the various StartHandler() methods. It is okay to call multiple times. A
  //! new signal stack will be allocated only if there is no existing stack or
  //! it is too small. The stack will be freed when the thread exits.
  //!
