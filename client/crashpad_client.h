...
class CrashpadClient {
 public:
  ...
  //! \brief Installs a signal handler to execute a Crashpad handler executable
  //!     by loading it with `/system/bin/linker`.
  //!
  ...
  //!     "/data/app/myapk.apk!/myabi/libhandler_trampoline.so".
  ...
  //! \brief Starts a handler process with an initial client by loading it with
  //!     `/system/bin/linker`.
  //!
  //! This method is only supported by Android Q+.
  //!
