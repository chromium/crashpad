...
//! \brief Builds a vector of argv suitable for invoking a handler process
//!     based on arguments passed StartHandler-type().
//!
//! See StartHandlerAtCrash() for documentation on the input arguments.
//!
//! \param[out] A vector of arguments suitable for starting the handler with.
