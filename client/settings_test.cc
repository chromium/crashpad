...
class SettingsTest : public testing::Test {
 public:
  ...
  void InitializeBadDirectory() {
    ...
    ScopedFileHandle client_id(
        LoggingOpenFileForWrite(settings_path().Append("client_id"),
                                FileWriteMode::kTruncateOrCreate,
                                FilePermissions::kWorldReadable));
    ...
    ScopedFileHandle uploads_enabled(
        LoggingOpenFileForWrite(settings_path().Append("uploads_enabled"),
                                FileWriteMode::kTruncateOrCreate,
                                FilePermissions::kWorldReadable));
  }
