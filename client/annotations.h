...
//! \brief The data structure that is defined for 
...
#define CRASHPAD_DECLARE_ANNOTATION(key_name) \
  extern crashpad::internal::RawAnnotation g_crashpad_annotation_##key_name

//! \brief Sets the value of an annotation previously defined by
//!     CRASHPAD_DEFINE_ANNOTATION_STRING(). Ownership of the string pointer is
//!     not taken, so common usage is for \a value to be a string constant.
...
//! \brief Sets the value of an annotation previously defined by
//!     CRASHPAD_DEFINE_ANNOTATION_STRING(). Ownership of the string pointer
//!     is
//!     not taken, so common usage is for \a value to be a string constant.
