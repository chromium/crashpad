...
class CrashReportDatabase {
 public:
  ...
  struct Report {
    ...
    //! uploaded. This can be true only if report is in 'pending' state.
  ...
  enum OperationStatus {
    ...
    //! \brief A report cannot be uploaded by user request as it has already
    //! been uploaded.
  ...
  //! \brief Moves a crash report to 'pending' state and marks it as explicitly
  //! requested by user.
  //!
  //! \param[in] uuid The unique identifier for the crash report record.
  //!
