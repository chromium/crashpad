...
class CrashHandler : public Thread,
 ...
 private:
  ...
  void HandleUncaughtNSException(NativeCPUContext* context) override {
...
void CrashpadClient::DumpWithoutCrash(NativeCPUContext* context) {
  CrashHandler* crash_handler = CrashHandler::Get();
  DCHECK(crash_handler);
  // TODO: DumpWithoutCrash should probably return a UUID, and
  // ProcessIntermediateDump should take a single UUID.
