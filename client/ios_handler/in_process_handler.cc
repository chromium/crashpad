...
#if defined(ARCH_CPU_X86_64)
  Property(fd_, "thread_state", &context->uc_mcontext->__ss, sizeof(x86_thread_state64_t));
  Property(fd_, "float_state", &context->uc_mcontext->__fs, sizeof(x86_float_state64_t));
#elif defined(ARCH_CPU_ARM64)
  Property(fd_, "thread_state", &context->uc_mcontext->__ss, sizeof(arm_thread_state64_t));
  Property(fd_, "float_state", &context->uc_mcontext->__ns, sizeof(arm_neon_state64_t));
#else
