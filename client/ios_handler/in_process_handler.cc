...
void InProcessHandler::DumpExceptionFromSignal(
  ...
  ObjectStart(fd_, "SignalException");

  Property(fd_, "siginfo", siginfo, sizeof(siginfo_t));
  Property(fd_, "siginfo", context, sizeof(ucontext_t));
