...
// static
void InProcessHandlerUtil::WriteHeader(IOSIntermediatedumpWriter* writer) {
  uint8_t version = 1;
  writer->AddProperty(IntermediateDumpKey::kVersion, &version, sizeof(version));
}

// static
void InProcessHandlerUtil::WriteProcessInfo(IOSIntermediatedumpWriter* writer) {
...
// static
void InProcessHandlerUtil::WriteSystemInfo(
...
// static
void InProcessHandlerUtil::WriteThreadInfo(IOSIntermediatedumpWriter* writer) {
...
// static
void InProcessHandlerUtil::WriteModuleInfo(IOSIntermediatedumpWriter* writer) {
...
// static
void InProcessHandlerUtil::WriteModuleInfoAtAddress(
    IOSIntermediatedumpWriter* writer,
    uint64_t address) {
...
// static
void InProcessHandlerUtil::WriteMachExceptionInfo(
    IOSIntermediatedumpWriter* writer,
...
// static
void InProcessHandlerUtil::WriteExceptionFromSignal(
    IOSIntermediatedumpWriter* writer,
    const IOSSystemDataCollector& system_data,
    siginfo_t* siginfo,
    ucontext_t* context) {
