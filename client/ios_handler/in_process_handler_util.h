...
#ifndef CRASHPAD_CLIENT_IOS_HANDLER_IN_PROCESS_HANDLER_UTIL_H_
#define CRASHPAD_CLIENT_IOS_HANDLER_IN_PROCESS_HANDLER_UTIL_H_

namespace crashpad {
namespace internal {

class InProcessHandlerUtil final {
 public:
 ...
 private:
  DISALLOW_IMPLICIT_CONSTRUCTORS(InProcessHandlerUtil);
};

}  // namespace internal
}  // namespace crashpad

#endif  // CRASHPAD_CLIENT_IOS_HANDLER_IN_PROCESS_HANDLER_UTIL_H_
