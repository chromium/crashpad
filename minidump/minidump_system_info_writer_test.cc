...
TEST(MinidumpSystemInfoWriter, Empty) {
  ...
  EXPECT_EQ(
            system_info->ProcessorArchitecture,kMinidumpCPUArchitectureUnknown);
...
TEST(MinidumpSystemInfoWriter, AMD64_Mac) {
  ...
  EXPECT_EQ( system_info->SuiteMask,0u);
  EXPECT_EQ(
            system_info->Cpu.OtherCpuInfo.ProcessorFeatures[0],kCPUFeatures[0]);
  EXPECT_EQ(
            system_info->Cpu.OtherCpuInfo.ProcessorFeatures[1],kCPUFeatures[1]);
}
...
TEST(MinidumpSystemInfoWriter, InitializeFromSnapshot_X86) {
  ...
  EXPECT_EQ(
            system_info->ProcessorArchitecture,expect_system_info.ProcessorArchitecture);
  EXPECT_EQ( system_info->ProcessorLevel,expect_system_info.ProcessorLevel);
  EXPECT_EQ(
            system_info->ProcessorRevision,expect_system_info.ProcessorRevision);
  EXPECT_EQ(
            system_info->NumberOfProcessors,expect_system_info.NumberOfProcessors);
  ...
  EXPECT_EQ(
            system_info->Cpu.X86CpuInfo.VendorId[0],expect_system_info.Cpu.X86CpuInfo.VendorId[0]);
  EXPECT_EQ(
            system_info->Cpu.X86CpuInfo.VendorId[1],expect_system_info.Cpu.X86CpuInfo.VendorId[1]);
  EXPECT_EQ(
            system_info->Cpu.X86CpuInfo.VendorId[2],expect_system_info.Cpu.X86CpuInfo.VendorId[2]);
  EXPECT_EQ(
            system_info->Cpu.X86CpuInfo.VersionInformation,expect_system_info.Cpu.X86CpuInfo.VersionInformation);
  EXPECT_EQ(
            system_info->Cpu.X86CpuInfo.FeatureInformation,expect_system_info.Cpu.X86CpuInfo.FeatureInformation);
...
TEST(MinidumpSystemInfoWriter, InitializeFromSnapshot_AMD64) {
  ...
  EXPECT_EQ( system_info->SuiteMask,expect_system_info.SuiteMask);
  EXPECT_EQ(
            system_info->Cpu.OtherCpuInfo.ProcessorFeatures[0],expect_system_info.Cpu.OtherCpuInfo.ProcessorFeatures[0]);
  EXPECT_EQ(
            system_info->Cpu.OtherCpuInfo.ProcessorFeatures[1],expect_system_info.Cpu.OtherCpuInfo.ProcessorFeatures[1]);
