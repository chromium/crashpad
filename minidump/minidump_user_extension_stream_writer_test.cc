...
TEST(MinidumpUserExtensionStreamWriter, NoData) {
  MinidumpFileWriter minidump_file_writer;
  auto user_stream_writer =
      base::WrapUnique(new MinidumpUserExtensionStreamWriter());
  const uint32_t kTestStreamId = 0x123456;
  auto stream =
      base::WrapUnique(new MinidumpUserExtensionStream());
...
TEST(MinidumpUserExtensionStreamWriter, OneStream) {
  MinidumpFileWriter minidump_file_writer;
  auto user_stream_writer =
      base::WrapUnique(new MinidumpUserExtensionStreamWriter());
  const uint32_t kTestStreamId = 0x123456;
