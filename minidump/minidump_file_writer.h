...
class MinidumpFileWriter final : public internal::MinidumpWritable {
 public:
  //! \brief Whether this object writes full or compact minidump.
  //!
  //! In \a kCompact mode, only exception thread is written to minidump file
  //! if any, otherwise all threads will be written.
