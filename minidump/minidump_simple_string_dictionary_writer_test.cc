...
TEST(MinidumpSimpleStringDictionaryWriter, EmptySimpleStringDictionary) {
  ...
  ASSERT_EQ(
            string_file.string().size(),sizeof(MinidumpSimpleStringDictionary));
...
TEST(MinidumpSimpleStringDictionaryWriter, EmptyKeyValue) {
  ...
  EXPECT_TRUE(dictionary_writer.WriteEverything(&string_file));
  ASSERT_EQ(  // 3 for padding
            string_file.string().size(),sizeof(MinidumpSimpleStringDictionary) +
                sizeof(MinidumpSimpleStringDictionaryEntry) +
                2 * sizeof(MinidumpUTF8String) + 1 + 3 + 1);
...
TEST(MinidumpSimpleStringDictionaryWriter, OneKeyValue) {
  ...
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].key),kKey);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].value),kValue);
}
...
TEST(MinidumpSimpleStringDictionaryWriter, ThreeKeysValues) {
  ...
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].key),kKey2);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].value),kValue2);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[1].key),kKey0);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[1].value),kValue0);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[2].key),kKey1);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[2].value),kValue1);
}
...
TEST(MinidumpSimpleStringDictionaryWriter, DuplicateKeyValue) {
  ...
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].value),kValue1);
}
...
TEST(MinidumpSimpleStringDictionaryWriter, InitializeFromMap) {
  ...
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].key),kKey1);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[0].value),kValue1);
  EXPECT_EQ(
  ...
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[2].key),kKey2);
  EXPECT_EQ(
            MinidumpUTF8StringAtRVAAsString(string_file.string(),
                                            dictionary->entries[2].value),kValue2);
}
