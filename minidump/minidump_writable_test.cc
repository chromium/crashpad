...
TEST(MinidumpWritable, MinidumpWritable) {
...

  {
    ...
    EXPECT_EQ( string_file.string(),std::string("parent\0\0child_0\0child_1", 23));
    parent.Verify();
  }

  {
    ...
    EXPECT_EQ(
              string_file.string(),std::string("parent\0\0child\0\0\0grandchild", 26));
    parent.Verify();
  }
...

  {
    ...
    EXPECT_EQ(
              string_file.string(),std::string("parent\0\0grandchild\0\0child", 25));
    parent.Verify();
  }

  {
    ...
    EXPECT_EQ(
              string_file.string(),std::string("P..\0C0.\0G00\0G01\0C1.\0G10\0G11", 27));
    parent.Verify();
  }

  {
    ...
    EXPECT_EQ( string_file.string().size(),27u);
    EXPECT_EQ(
              string_file.string(),std::string("P..\0G00\0G01\0C1.\0G10\0G11\0C0.", 27));
    parent.Verify();
  }

  {
    ...
    EXPECT_EQ( string_file.string().size(),27u);
    EXPECT_EQ(
              string_file.string(),std::string("P..\0C0.\0C1.\0G10\0G11\0G00\0G01", 27));
    parent.Verify();
  }
