...
TEST(MinidumpModuleCrashpadInfoWriter, ThreeModules) {
  ...
  annotation_writer_0->InitializeFromAnnotation(annotation0);
  ...
  annotation_writer_2a->InitializeFromAnnotation(annotation2a);
  auto annotation_writer_2b = std::make_unique<MinidumpAnnotationWriter>();
  annotation_writer_2b->InitializeFromAnnotation(annotation2b);
