...
their crashes. On iOS there is no separate process for the handler and the
...
with a subset of available exceptions. See more information about [This is a
limitation of iOS.](ios_overview_design.md#ios-limitations)
