...
Additionally, embedders of the handler can provide "user stream data sources" to
the handler's main funciton. These data sources are are invoked at postmortem
crash capture time.
