...
their crashes. On iOS there is not separate process for the handler and the
client. [This is a limitation of iOS.](ios_overview_design.md#ios-limitations)
...
with a subset of available exceptions. See more information about [iOS
...
port or the signal handler.  As exceptions are handled in-process, an
intermediate dump file is generated rather than a minidump. See more
information about the [iOS in-process handler
