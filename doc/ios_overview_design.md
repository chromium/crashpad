...
enabled, this minidump will also be immediately uploaded. New intermediate
dumps generated by exceptions or by DumpWithoutCrashAndDeferProcessing()
will will not be processed until the next call to `ProcessIntermediateDumps`.
Intermediate dumps generated by DumpWithoutCrash(), however, are automatically
converted to minidumps.
