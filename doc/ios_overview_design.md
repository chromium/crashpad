...
dumps. This is expected to happen during application startup, when suitable.
...
dumps generated after this call, such as simulated crash (dump-without-crashing)
dumps or new exceptions, will not be processed until the next call to
`ProcessIntermediateDumps`.
