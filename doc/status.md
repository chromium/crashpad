...
Windows, Android, Chromium OS, and Linux. Crashpad became the crash reporter
client for [Chromium](https://www.chromium.org/Home) on macOS as of [March
...
Linux](https://bugs.chromium.org/p/chromium/issues/detail?id=942279).

Work has begun on a Crashpad client for
[iOS](https://bugs.chromium.org/p/crashpad/issues/detail?id=31).
