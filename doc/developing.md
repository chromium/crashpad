 ...
 * Appropriate development tools.
    ...
    * On Windows, install [Visual Studio](https://www.visualstudio.com/). MSVS
      2015 and MSVS 2017 are both supported. Some tests also require the CDB
      debugger, installed with [Debugging Tools for Windows](https://msdn.microsoft.com/en-us/library/windows/hardware/ff551063.aspx).
 * Chromium’s
...
This can be installed either as part of the Windows Driver Kit or the Windows
SDK. If the Windows SDK has already been installed (possibly with Visual Studio)
but Debugging Tools for Windows is not present, it can be installed from Add or
