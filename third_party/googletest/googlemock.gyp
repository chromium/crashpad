  ...
  'targets': [
    {
      ...
      'sources': [
        '<(googlemock_dir)/include/googlemock/gmock-actions.h',
        '<(googlemock_dir)/include/googlemock/gmock-cardinalities.h',
        '<(googlemock_dir)/include/googlemock/gmock-function-mocker.h',
        '<(googlemock_dir)/include/googlemock/gmock-generated-actions.h',
        '<(googlemock_dir)/include/googlemock/gmock-matchers.h',
        '<(googlemock_dir)/include/googlemock/gmock-more-actions.h',
        '<(googlemock_dir)/include/googlemock/gmock-more-matchers.h',
        '<(googlemock_dir)/include/googlemock/gmock-nice-strict.h',
        '<(googlemock_dir)/include/googlemock/gmock-spec-builders.h',
        '<(googlemock_dir)/include/googlemock/gmock.h',
        '<(googlemock_dir)/include/googlemock/internal/custom/gmock-generated-actions.h',
        '<(googlemock_dir)/include/googlemock/internal/custom/gmock-matchers.h',
        '<(googlemock_dir)/include/googlemock/internal/custom/gmock-port.h',
        '<(googlemock_dir)/include/googlemock/internal/custom/gmock-pp.h',
        '<(googlemock_dir)/include/googlemock/internal/gmock-generated-internal-utils.h',
        '<(googlemock_dir)/include/googlemock/internal/gmock-internal-utils.h',
        '<(googlemock_dir)/include/googlemock/internal/gmock-port.h',
    ...
    {
      'target_name': 'googlemock_all_test',
      'dependencies': [
    ...
    {
      'target_name': 'googlemock_link_test',
      'dependencies': [
        'googlemock_test_executable',
        'googlemock_main',
      ],
    ...
    {
      'target_name': 'googlemock_stress_test',
      'dependencies': [
        'googlemock_test_executable',
      ],
      'sources': [
    ...
    },
    {
      ...
      'dependencies': [
        'googlemock_all_test',
        'googlemock_link_test',
        'googlemock_stress_test',
      ],
    },
  ],
}
